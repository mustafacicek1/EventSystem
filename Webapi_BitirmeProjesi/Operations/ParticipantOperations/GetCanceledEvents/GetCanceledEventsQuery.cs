...
namespace Webapi_BitirmeProjesi.Operations.ParticipantOperations.GetCanceledEvents
{
    public class GetCanceledEventsQuery
    {
        private readonly EventSystemDbContext _dbContext;

        public GetCanceledEventsQuery(EventSystemDbContext dbContext)
        {
